...
/* @var $model app\modules\administrator\models\ProjectSearch */
...
<div class="project-search">
    ...
    <div class="col-sm-3 my-1">
        <?= $form->field($model, 'client_name', ['options' => ['tag' => false]])->textInput(['class' => 'form-control mr-sm-2', 'placeholder' => 'Cari...'])->label('Klien', ['class' => 'sr-only'])->error(false) ?>
    </div>
    <div class="col-sm-3 my-1">
