...
<section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall " data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
  <!-- Parallax Image -->
  <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-size-cover g-bg-pos-top-center g-bg-black-opacity-0_3--after" style="height: 120%; background-image: url(img/GOLD-GEM-MINING.jpg);"></div>
  <!-- End Parallax Image -->

  <!-- Promo Block Content -->
  <div class="container g-color-white text-center g-pt-150 g-pb-20">
    <h4 class="h4 g-font-weight-300 mb-0 g-color-white">read the latest news and blogs</h4>
        <h2 class="g-font-weight-700 g-font-size-60 text-uppercase g-color-white">News Blog</h2>
  </div>
  <!-- Promo Block Content -->
</section>
<!-- End Promo Block -->
